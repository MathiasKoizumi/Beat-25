...
namespace WindowsFormsApplication1
{
	public class Form1 : Form
	{
		...
		public Form1()
		{
			...
			timer2 = new System.Timers.Timer(200000.0);
		...
		public void violenceNearby()
		{
			...
			for (int i = 0; i < junkie.Next(50, 500); i++)
			{
				if (junkie.Next(17) != 0)
				{
					...
					double num3 = junkie.NextDouble() + 0.3;
					gfx.DrawImage(image, new Rectangle(new Point(num + (int)(200.0 * Math.Sin(junkie.Next(10000))), num2 + (int)(300.0 * Math.Sin(junkie.Next(10000)))), new Size(new Point((int)((double)image.Width * num3), (int)((double)image.Height * num3)))));
					Thread.Sleep(junkie.Next(100));
				}
			}
			...
			gfx.DrawImage(image, new Rectangle(new Point(junkie.Next(1000), junkie.Next(300)), new Size(new Point(image.Width, image.Height))));
			Thread.Sleep(junkie.Next(2000));
			for (int j = 0; j < junkie.Next(50, 200); j++)
			{
				switch (junkie.Next(6))
				{
				case 0:
				...
				double num4 = junkie.NextDouble() + 0.1;
				gfx.DrawImage(image, new Rectangle(new Point(num + (int)(200.0 * Math.Sin(junkie.Next(10000))), num2 + (int)(300.0 * Math.Sin(junkie.Next(10000)))), new Size(new Point((int)((double)image.Width * num4), (int)((double)image.Height * num4)))));
				Thread.Sleep(junkie.Next(100));
			}
			for (int k = 0; k < junkie.Next(50, 200); k++)
			{
				...
				gfx.DrawImage(image, new Rectangle(new Point(num + (int)(200.0 * Math.Sin(junkie.Next(10000))), num2 + (int)(300.0 * Math.Sin(junkie.Next(10000)))), new Size(new Point((int)((double)image.Width * num5), (int)((double)image.Height * num5)))));
				Thread.Sleep(junkie.Next(100));
			}
		}
	}
